...
public class Gene_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("datatype.Gene");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "datatype.Gene");
  ...
  public int getSentenceStart(int addr) {
      ...
      jcas.throwFeatMissing("sentenceStart", "datatype.Gene");
